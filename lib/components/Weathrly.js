  ...
  render() {
    return (
      <div className='forecast-today'>
        ...
        <section></section>
        <WeatherCards location={ this.state.locationData } conditions={ this.state.conditions } weatherText={ this.state.weatherText } weatherSimple={ this.state.weatherSimple } notFound={this.state.notFound}/>
        <Hourly weatherHourly={ this.state.weatherHourly } notFound={this.state.notFound}/>
        <TenDay weatherText={ this.state.weatherText } weatherSimple={ this.state.weatherSimple } city={this.state.locationData.city} notFound={this.state.notFound} />
      </div>
    );
  }
}
